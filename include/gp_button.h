...
#define MORSE_BACKSPACE_PRESS_DURATION_MS 1500
// MORSE_DOT_PRESS_DURATION_MS is the duration the button needs to be held in order to clear the decoded morse message buffer.
#define MORSE_CLEAR_PRESS_DURATION_MS (2 * MORSE_BACKSPACE_PRESS_DURATION_MS)
// MORSE_DOT_PRESS_DURATION_MS is the duration to wait before decoding the buffered morse signals into a letter.
#define MORSE_INTERVAL_BETWEEN_LETTERS_MS (3 * MORSE_DOT_PRESS_DURATION_MS)
// MORSE_DOT_PRESS_DURATION_MS is the duration to wait before automatically inserting a space into the morse message buffer.
