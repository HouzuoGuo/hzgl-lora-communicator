...
#define SUPERVISOR_STUCK_PROGRESS_THRESHOLD ((POWER_GPS_RUN_SLEEP_INTERVAL_SEC + LORAWAN_TX_KINDS * POWER_SLOWEST_TX_INTERVAL_SEC) * 1000 / SUPERVISOR_TASK_LOOP_DELAY_MS + 1)
